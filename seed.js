...
async function seedData() {
  try {
    for (const question of questions) {
      const response = await axios.post('http://localhost:3001/api/add', question);
